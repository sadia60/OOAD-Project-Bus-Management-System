        <jsp:include page="header.jsp"></jsp:include>
            <div id="gbox-bg">
              <div id="gbox-grd">
                <h2>WELCOME TO OUR Dot to Dot Bus Sservice limited </h2>
				<marquee dir="ltr"><font style="color: navy;">Islamabad-Lahore,Lahore-Multan,Karachi-Quetta,Rawalpindi........</font></marquee>
				<p>You can find All the Information regarding our transport company's services ,Cargo Services and can contact us to get your vehicle installed in our company</p>
