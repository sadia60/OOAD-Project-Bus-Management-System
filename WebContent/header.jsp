        ...
        <div id="body-top">
          ...
          <div id="nav">
            <ul>
              ...
              <li><a href="ritruck.jsp">RESERVATION</a></li>
              <li><a href="status.jsp">CONTACT US</a></li>
              <li><a href="towards.jsp">ABOUT</a></li>
...
out.print("<li><a href='contactus.jsp'>CONTACT US</a></li>");
		  ...
		  <div id="page-title">
				  <span>
					 ...
					 <h2 style="color:#4f7202;">BUS SERVICES</h2>
				   </span>
